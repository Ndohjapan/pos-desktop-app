...
class ErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    ...
    return (
      <div className="w-full h-screen flex items-center justify-center bg-[#F5F5F5] p-6">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              ...
              className="w-full py-3 rounded-lg bg-primary-700 text-white font-bold hover:bg-primary-900"
            >
              Reload App
            </button>
            <button
              onClick={this.handleDisableGpu}
              className="w-full py-2 rounded-lg border border-[#DCDCDC] text-secondary text-sm hover:bg-gray-50"
            >
